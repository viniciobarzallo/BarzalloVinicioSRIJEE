...
a persistence unit "BarzalloVinicioOperadoraJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "BarzalloVinicioOperadoraJEE\pom.xml":
...
artifact ("BarzalloVinicioOperadoraJEE.war") is already built. You can build
